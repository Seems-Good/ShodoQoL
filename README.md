...
<img width="907" height="714" alt="image" src="https://github.com/user-attachments/assets/1403eb2e-3b1d-41c8-9b4f-01cbef4ce518" />
...
**Description:**  
Live Prescience buff state tracking "aura" on your P1 and P2 targets.  
Color-coded:
- 🟢 active (`o`)
- 🟠 expiring (`!`)
- 🔴 missing (`x`)
